...
## Purpose
Editable block-level structure — lists, task lists, blockquotes, code blocks and horizontal rules — with preservation kept for content the schema does not model. Created by archiving change inline-block-formatting.
## Requirements
### Requirement: Lists
