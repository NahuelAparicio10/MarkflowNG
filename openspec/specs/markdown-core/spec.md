...
## Purpose
The Markdown core: parsing to canonical mdast, deterministic serialization, the ProseMirror schema and the bidirectional mapping between them, with preservation of unsupported content and enforced round-trip invariants. Created by archiving change markdown-core-roundtrip; extended by inline-block-formatting and tables-and-images.
## Requirements
