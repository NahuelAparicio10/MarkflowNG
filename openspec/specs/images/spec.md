...
## Purpose
Images: inserting by file, paste and drag and drop, displaying in reader and editor, storing references relative to the document inside the workspace, and persisting display size in the title field. Created by archiving change tables-and-images.
## Requirements
